...
const Footer = () => {
  return (
    <footer id="contact" className="bg-footer p-8 xl:p-20  ">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-b border-gray-500 pb-8">
        ...
        <nav className="flex items-center justify-center gap-6">
          <a
            href=""
            target="_blank"
            className=" block text-2xl text-white bg-primary p-4 rounded-full"
          >
            <RiInstagramLine />
          </a>
          <a
      ...
      <div>
        <p className=" flex  justify-center items-center p-8 text-gray-400">
          © GastonDev 2023 - All Rights Reserved
        </p>
      </div>
    </footer>
  );
